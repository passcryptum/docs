...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        text: 'Overview',
        items: [
          { text: 'Glossary', link: '/overview/glossary.html' },
      ...
      },
      {
        text: 'How-tos',
        items: [
          { text: 'General', link: '/how-tos/general' },
          { text: 'Services', link: '/how-tos/services' },
          { text: 'Password', link: '/how-tos/password' },
          { text: 'Storage', link: '/how-tos/storage' },
    ...
    socialLinks: [
      {
        icon: {
          svg: '<svg xmlns="http://www.w3.org/2000/svg" width="240" height="240" viewBox="0 0 240 240" fill="none">\n' +
            '<g clip-path="url(#clip0_1533_119)">\n' +
            '<path d="M120 240C186.274 240 240 186.274 240 120C240 53.7258 186.274 0 120 0C53.7258 0 0 53.7258 0 120C0 186.274 53.7258 240 120 240Z" fill="#37B2E8"/>\n' +
            '<path d="M81.2285 128.771L95.4655 168.177C95.4655 168.177 97.2455 171.864 99.1515 171.864C101.058 171.864 129.407 142.372 129.407 142.372L160.932 81.4824L81.7365 118.599L81.2285 128.771Z" fill="#C8DAEA"/>\n' +
            '<path d="M100.106 138.879L97.3731 167.925C97.3731 167.925 96.2291 176.825 105.127 167.925C114.025 159.025 122.542 152.162 122.542 152.162" fill="#A9C6D8"/>\n' +
      ...
      },
      {
        ...
        link: 'https://t.me/passcryptum_chat',
        ariaLabel: 'International chat @passcryptum_chat'
      },
      {
        icon: {
          svg: '<svg xmlns="http://www.w3.org/2000/svg" width="240" height="240" viewBox="0 0 240 240" fill="none">\n' +
        ...
        link: 'https://t.me/passcryptum_ru',
        ariaLabel: 'Russian chat @passcryptum_ru'
      },
    ],
  },
})
